...
public class NewsController {
    ...
    @GetMapping
    @Operation(summary = "responsible for list new news ordered by creation date", description = "list new news ordered by creation date", 
                tags = { "News" }, 
                responses = { 
                    @ApiResponse(description = "Success", responseCode = "200", 
                        content = {
                            @Content(mediaType = "application/json", 
                                array = 
                                    @ArraySchema(schema = @Schema(implementation = NewsDto.class))
                                    )
                                }
                            ),
    ...
    @PostMapping
    @Transactional
    @Operation(summary = "Add a new News", description = "Add a new News", 
        tags = { "News" }, 
        responses = {
