...
public class DestinationsController {
    ...
    @GetMapping
    @Operation(summary = "responsible for list destinations ordered by city name", description = "list destinations ordered by city name", 
    tags = { "Destinations" }, 
    responses = { 
        @ApiResponse(description = "Success", responseCode = "200", 
            content = {
                @Content(mediaType = "application/json", 
                    array = 
                        @ArraySchema(schema = @Schema(implementation = DestinationsDto.class))
                        )
                    }
                ),
    ...
    @PostMapping
    @Transactional
    @Operation(summary = "Add a new destinations", description = "Add a new destinations", 
        tags = { "Destinations" }, 
        responses = {
